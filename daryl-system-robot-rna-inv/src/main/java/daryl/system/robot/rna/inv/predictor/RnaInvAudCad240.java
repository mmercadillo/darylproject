...
import daryl.system.robot.rna.inv.predictor.config.ConfiguracionRnaAudCad240;
...
@ToString
public class RnaInvAudCad240  extends RnaPredictor{

	@Autowired(required = true)
	ConfiguracionRnaAudCad240 configuracion;
	...
	protected Double calcularPrediccion(Robot bot) {
        ...
        prediccion = nuevaPrediccion - RnaInvAudCad240.prediccionAnterior;
        RnaInvAudCad240.prediccionAnterior = nuevaPrediccion;
