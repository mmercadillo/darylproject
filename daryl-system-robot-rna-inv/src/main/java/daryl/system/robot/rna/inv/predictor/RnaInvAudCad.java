...
@ToString
public class RnaInvAudCad  extends RnaPredictor{
	...
	protected Double calcularPrediccion(Robot bot) {
        ...
        prediccion = nuevaPrediccion - RnaInvAudCad.prediccionAnterior;
        RnaInvAudCad.prediccionAnterior = nuevaPrediccion;
