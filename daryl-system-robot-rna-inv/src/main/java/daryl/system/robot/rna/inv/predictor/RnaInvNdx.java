...
import daryl.system.robot.rna.inv.predictor.config.ConfiguracionRnaNdx60;
...
@ToString
public class RnaInvNdx  extends RnaPredictor{
	...
	protected Double calcularPrediccion(Robot bot) {
        ...
        prediccion = nuevaPrediccion - RnaInvNdx.prediccionAnterior;
        RnaInvNdx.prediccionAnterior = nuevaPrediccion;
		return prediccion;
