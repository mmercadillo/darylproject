...
import daryl.system.robot.rna.inv.predictor.config.ConfiguracionRnaNdx10080;
import daryl.system.robot.rna.inv.repository.IHistNdxRepository;
import lombok.ToString;

@Component(value = "rnaInvNdx10080")
@ToString
public class RnaInvNdx10080  extends RnaPredictor{
	
	@Autowired
	Logger logger;
	
	@Autowired(required = true)
	ConfiguracionRnaNdx10080 configuracion;
	@Autowired
	...
	public final String robot = "RNA_I_NDX_10080";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//Ndx10080Controller.orden = orden.getTipoOrden();
