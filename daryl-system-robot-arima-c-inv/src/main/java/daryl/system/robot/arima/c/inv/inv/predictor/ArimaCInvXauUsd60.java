...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaXauUsd60;
...
@Component(value = "arimaCInvXauusd60")
@ToString
public class ArimaCInvXauUsd60  extends ArimaPredictor{
