...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaGdaxi;
...
@Component(value = "arimaCInvGdaxi60")
@ToString
public class ArimaCInvGdaxi60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_GDAXI_60";
	private final String robot_config= "ARIMA_C_GDAXI_60";
