...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaXauUsd1440;
import daryl.system.robot.arima.c.inv.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.c.inv.inv.repository.IHistXauUsdRepository;
import lombok.ToString;

@Component(value = "arimaCInvXauusd1440")
@ToString
public class ArimaCInvXauUsd1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_XAUUSD_1440";
	private final String robot_config= "ARIMA_C_XAUUSD_1440";
