...
import daryl.system.robot.arima.c.inv.predictor.config.ConfiguracionArimaEurUsd240;
...
@Component(value = "arimaCInvEurusd240")
@ToString
public class ArimaCInvEurusd240  extends ArimaPredictor{
