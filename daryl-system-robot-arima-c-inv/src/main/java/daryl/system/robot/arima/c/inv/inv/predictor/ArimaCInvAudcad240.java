...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaAudCad240;
...
@Component(value = "arimaCInvAudcad240")
@ToString
public class ArimaCInvAudcad240  extends ArimaPredictor{
