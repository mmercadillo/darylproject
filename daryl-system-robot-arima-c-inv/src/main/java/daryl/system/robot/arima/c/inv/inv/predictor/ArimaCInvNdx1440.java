...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaNdx1440;
...
@Component(value = "arimaCInvNdx1440")
@ToString
public class ArimaCInvNdx1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_NDX_1440";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaBNdxD1Controller.orden = orden.getTipoOrden();
