...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaAudCad1440;
import daryl.system.robot.arima.c.inv.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.c.inv.inv.repository.IHistAudCadRepository;
import lombok.ToString;

@Component(value = "arimaCInvAudcad1440")
@ToString
public class ArimaCInvAudcad1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_AUDCAD_1440";	
	private final String robot_config= "ARIMA_C_AUDCAD_1440";
