...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaNdx60;
import daryl.system.robot.arima.c.inv.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.c.inv.inv.repository.IHistNdxRepository;
import lombok.ToString;

@Component(value = "arimaCInvNdx60")
@ToString
public class ArimaCInvNdx60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_NDX_60";
	private final String robot_config= "ARIMA_C_NDX_60";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaBNdxController.orden = orden.getTipoOrden();
