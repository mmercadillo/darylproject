...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaWti240;
import daryl.system.robot.arima.c.inv.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.c.inv.inv.repository.IHistWtiRepository;
...
public class ArimaCInvWti240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_WTI_240";
