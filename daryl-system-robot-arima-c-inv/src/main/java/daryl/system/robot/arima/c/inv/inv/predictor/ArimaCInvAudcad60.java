...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaAudCad60;
...
@Component(value = "arimaCInvAudcad60")
@ToString
public class ArimaCInvAudcad60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_AUDCAD_60";
