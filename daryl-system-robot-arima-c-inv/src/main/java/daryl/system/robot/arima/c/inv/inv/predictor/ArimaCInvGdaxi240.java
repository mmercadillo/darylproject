...
import daryl.system.robot.arima.c.inv.inv.predictor.config.ConfiguracionArimaGdaxi240;
import daryl.system.robot.arima.c.inv.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.c.inv.inv.repository.IHistGdaxiRepository;
import lombok.ToString;

@Component(value = "arimaCInvGdaxi240")
@ToString
public class ArimaCInvGdaxi240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_C_GDAXI_240";
	private final String robot_config= "ARIMA_C_GDAXI_240";
