...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaNdx240;
...
@Component(value = "arimaDInvNdx240")
@ToString
public class ArimaDInvNdx240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_NDX_240";
	private final String robot_config= "ARIMA_D_NDX_240";
