...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaWti240;
...
@Component(value = "arimaDInvWti240")
@ToString
public class ArimaDInvWti240  extends ArimaPredictor{
	...
	protected Double calcularPrediccion() {
		...
		historico = histWtiRepository.findAllByTimeframeOrderByFechaHoraAsc(Timeframes.PERIOD_H4);
