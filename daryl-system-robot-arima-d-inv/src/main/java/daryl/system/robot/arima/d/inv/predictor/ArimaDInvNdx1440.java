...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaNdx1440;
...
@Component(value = "arimaDInvNdx1440")
@ToString
public class ArimaDInvNdx1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_NDX_1440";
	private final String robot_config= "ARIMA_D_NDX_1440";
