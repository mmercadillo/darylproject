...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaEurUsd240;
...
@Component(value = "arimaDInvEurusd240")
@ToString
public class ArimaDInvEurusd240  extends ArimaPredictor{
	...
	//private final String robot= "ARIMA_I_D_EURUSD_240";
	private final String robot_config= "ARIMA_D_EURUSD_240";
