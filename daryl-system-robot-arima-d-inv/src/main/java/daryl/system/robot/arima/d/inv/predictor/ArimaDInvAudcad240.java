...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaAudCad240;
...
@Component(value = "arimaDInvAudcad240")
@ToString
public class ArimaDInvAudcad240  extends ArimaPredictor{
