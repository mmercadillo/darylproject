...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaXauUsd60;
...
@Component(value = "arimaDInvXauusd60")
@ToString
public class ArimaDInvXauUsd60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_XAUUSD_60";
	private final String robot_config= "ARIMA_D_XAUUSD_60";
