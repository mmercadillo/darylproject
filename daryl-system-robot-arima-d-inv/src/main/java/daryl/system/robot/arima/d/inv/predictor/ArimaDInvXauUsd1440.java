...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaXauUsd1440;
...
@Component(value = "arimaDInvXauusd1440")
@ToString
public class ArimaDInvXauUsd1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_XAUUSD_1440";
	private final String robot_config= "ARIMA_D_XAUUSD_1440";
