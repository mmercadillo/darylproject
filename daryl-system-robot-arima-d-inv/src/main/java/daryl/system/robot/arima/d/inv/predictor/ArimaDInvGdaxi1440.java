...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaGdaxi1440;
...
@Component(value = "arimaDInvGdaxi1440")
@ToString
public class ArimaDInvGdaxi1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_GDAXI_1440";
	private final String robot_config= "ARIMA_D_GDAXI_1440";
