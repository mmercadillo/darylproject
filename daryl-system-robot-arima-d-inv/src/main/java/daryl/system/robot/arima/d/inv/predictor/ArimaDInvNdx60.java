...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaNdx60;
...
@Component(value = "arimaDInvNdx60")
@ToString
public class ArimaDInvNdx60  extends ArimaPredictor{
	...
	//private final String robot= "ARIMA_I_D_NDX_60";
	private final String robot_config= "ARIMA_D_NDX_60";
