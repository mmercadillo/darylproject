...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaWti1440;
import daryl.system.robot.arima.d.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.d.inv.repository.IHistWtiRepository;
import lombok.ToString;

@Component(value = "arimaDInvWti1440")
@ToString
public class ArimaDInvWti1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_WTI_1440";
	private final String robot_config= "ARIMA_D_WTI_1440";
