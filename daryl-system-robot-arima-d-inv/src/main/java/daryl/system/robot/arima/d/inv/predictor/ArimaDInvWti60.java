...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaWti60;
...
@Component(value = "arimaDInvWti60")
@ToString
public class ArimaDInvWti60  extends ArimaPredictor{
	...
	//private final String robot= "ARIMA_I_D_WTI_60";
	private final String robot_config= "ARIMA_D_WTI_60";
