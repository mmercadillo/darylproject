...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaAudCad10080;
import daryl.system.robot.arima.d.inv.repository.IArimaConfigRepository;
import daryl.system.robot.arima.d.inv.repository.IHistAudCadRepository;
...
public class ArimaDInvAudcad10080  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_AUDCAD_10080";
	private final String robot_config= "ARIMA_D_AUDCAD_10080";
	...
	protected Double calcularPrediccion() {
		...
		historico = histAudCadRepository.findAllByTimeframeOrderByFechaHoraAsc(Timeframes.PERIOD_W1);
