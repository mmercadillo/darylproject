...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaAudCad1440;
...
@Component(value = "arimaDInvAudcad1440")
@ToString
public class ArimaDInvAudcad1440  extends ArimaPredictor{
	...
	//private final String robot= "ARIMA_I_D_AUDCAD_1440";
	private final String robot_config= "ARIMA_D_AUDCAD_1440";
