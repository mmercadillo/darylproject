...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaGdaxi240;
...
@Component(value = "arimaDInvGdaxi240")
@ToString
public class ArimaDInvGdaxi240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_I_D_GDAXI_240";
	private final String robot_config= "ARIMA_D_GDAXI_240";
