...
import daryl.system.robot.arima.d.inv.predictor.config.ConfiguracionArimaAudCad60;
...
@Component(value = "arimaDInvAudcad60")
@ToString
public class ArimaDInvAudcad60  extends ArimaPredictor{
