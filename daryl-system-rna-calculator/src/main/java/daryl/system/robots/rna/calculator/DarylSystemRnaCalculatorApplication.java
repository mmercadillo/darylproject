...
public class DarylSystemRnaCalculatorApplication {
	...
	private static void startForecaster(ConfigurableApplicationContext context) {
		...
		if(DarylSystemRnaCalculatorApplication.ACTIVE_60 == Boolean.TRUE) {
		...
		if(DarylSystemRnaCalculatorApplication.ACTIVE_240 == Boolean.TRUE) {
		...
		if(DarylSystemRnaCalculatorApplication.ACTIVE_1440 == Boolean.TRUE) {
		...
		if(DarylSystemRnaCalculatorApplication.ACTIVE_10080 == Boolean.TRUE) {
