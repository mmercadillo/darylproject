...
import daryl.system.robot.variance.b.repository.IHistXauUsdRepository;
...
@ToString
public class VarianceBXauUsd  extends VariancePredictor{

	
	@Autowired
	IVarianceConfigRepository varianceConfigRepository;
	@Autowired
	private IHistAudCadRepository histXauUsdRepository;
	...
	protected Double calcularPrediccion(Robot bot) {
		...
		List<HistAudCad> historico = histXauUsdRepository.findAllByTimeframeOrderByFechaHoraAsc(bot.getTimeframe());
