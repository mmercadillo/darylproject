...
import daryl.system.robot.variance.b.repository.IHistWtiRepository;
...
@ToString
public class VarianceBWti  extends VariancePredictor{
	
	@Autowired
	IVarianceConfigRepository varianceConfigRepository;
	@Autowired
	private IHistAudCadRepository histWtiRepository;
	...
	protected Double calcularPrediccion(Robot bot) {
		...
		List<HistAudCad> historico = histWtiRepository.findAllByTimeframeOrderByFechaHoraAsc(bot.getTimeframe());
