...
import daryl.system.robot.variance.b.repository.IHistGdaxiRepository;
...
@ToString
public class VarianceBGdaxi  extends VariancePredictor{
	
	@Autowired
	IVarianceConfigRepository varianceConfigRepository;
	@Autowired
	private IHistAudCadRepository histGdaxiRepository;
	...
	protected Double calcularPrediccion(Robot bot) {
		...
		try {
			...
			List<HistAudCad> historico = histGdaxiRepository.findAllByTimeframeOrderByFechaHoraAsc(bot.getTimeframe());
