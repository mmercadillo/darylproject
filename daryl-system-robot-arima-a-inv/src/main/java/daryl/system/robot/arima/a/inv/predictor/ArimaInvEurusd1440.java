...
import daryl.system.robot.arima.a.inv.predictor.config.ConfiguracionArimaEurUsd1440;
import daryl.system.robot.arima.a.inv.repository.IHistEurUsdRepository;
import lombok.ToString;

@Component(value = "arimaInvEurusd1440")
@ToString
public class ArimaInvEurusd1440  extends ArimaPredictor{
	...
	private final String robot = "ARIMA_I_EURUSD_1440";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaEurUsdD1Controller.orden = orden.getTipoOrden();
