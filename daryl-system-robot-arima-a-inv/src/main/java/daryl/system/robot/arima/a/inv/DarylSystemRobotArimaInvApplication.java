package daryl.system.robot.arima.a.inv;
...
public class DarylSystemRobotArimaInvApplication {

	public static void main(String[] args) {
		
        SpringApplicationBuilder builder = new SpringApplicationBuilder(DarylSystemRobotArimaInvApplication.class);
