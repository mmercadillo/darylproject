...
import daryl.system.robot.arima.a.inv.predictor.config.ConfiguracionArimaNdx60;
import daryl.system.robot.arima.a.inv.repository.IHistNdxRepository;
import lombok.ToString;

@Component(value = "arimaInvNdx60")
@ToString
public class ArimaInvNdx60  extends ArimaPredictor{
	...
	private final String robot = "ARIMA_I_NDX_60";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaNdxController.orden = orden.getTipoOrden();
