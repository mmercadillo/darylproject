...
import daryl.system.robot.arima.a.inv.predictor.config.ConfiguracionArimaGdaxi;
import daryl.system.robot.arima.a.inv.repository.IHistGdaxiRepository;
import lombok.ToString;

@Component(value = "arimaInvGdaxi60")
@ToString
public class ArimaInvGdaxi60  extends ArimaPredictor{
	...
	private final String robot = "ARIMA_I_GDAXI_60";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaGdaxiController.orden = orden.getTipoOrden();
