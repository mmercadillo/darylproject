...
import daryl.system.robot.arima.a.inv.predictor.config.ConfiguracionArimaAudCad240;
import daryl.system.robot.arima.a.inv.repository.IHistAudCadRepository;
import lombok.ToString;

@Component(value = "arimaInvAudcad240")
@ToString
public class ArimaInvAudcad240  extends ArimaPredictor{
	...
	private final String robot = "ARIMA_I_AUDCAD_240";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaAudCadH4Controller.orden = orden.getTipoOrden();
