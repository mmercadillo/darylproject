...
import daryl.system.robot.arima.b.predictor.config.ConfiguracionArimaGdaxi10080;
import daryl.system.robot.arima.b.repository.IHistGdaxiRepository;
import lombok.ToString;

@Component(value = "arimaBGdaxi10080")
@ToString
public class ArimaBGdaxi10080  extends ArimaPredictor{
	...
	private final String robot = "ARIMA_B_GDAXI_10080";
	...
	protected Double calcularPrediccion() {
		...
		historico = histGdaxiRepository.findAllByTimeframeOrderByFechaHoraAsc(Timeframes.PERIOD_W1);
