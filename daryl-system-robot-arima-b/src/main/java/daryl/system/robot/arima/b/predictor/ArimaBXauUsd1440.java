...
import daryl.system.robot.arima.b.predictor.config.ConfiguracionArimaXauUsd1440;
import daryl.system.robot.arima.b.repository.IHistXauUsdRepository;
import lombok.ToString;

@Component(value = "arimaBXauusd1440")
@ToString
public class ArimaBXauUsd1440  extends ArimaPredictor{
	...
	//private final String robot = "ARIMA_B_XAUUSD_1440";
	...
	public void calculate(Robot bot) {
		...
		//ArimaBXauUsdD1Controller.orden = orden.getTipoOrden();
