...
import daryl.system.robot.rna.predictor.config.ConfiguracionRnaXauUsd240;
import daryl.system.robot.rna.repository.IHistXauUsdRepository;
import lombok.ToString;

@Component(value = "rnaXauusd240")
@ToString
public class RnaXauUsd240  extends RnaPredictor{
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//logger.info("Nueva predicción para el XAUUSD 4H : {} a las: {}" , prediccion, config.getActualDateFormattedInString());
		...
		//XauUsdController240.orden = orden.getTipoOrden();
