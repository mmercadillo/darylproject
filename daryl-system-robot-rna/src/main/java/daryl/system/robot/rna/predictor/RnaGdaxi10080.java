...
import daryl.system.robot.rna.predictor.config.ConfiguracionRnaGdaxi10080;
import daryl.system.robot.rna.repository.IHistGdaxiRepository;
import lombok.ToString;

@Component(value = "rnaGdaxi10080")
@ToString
public class RnaGdaxi10080  extends RnaPredictor{
	...
	public final String robot = "RNA_GDAXI_10080";
	...
	protected Double calcularPrediccion() {
        ...
        try {
			//System.out.println("PRED GDAXI W1 ANT -> " + prediccionAnterior + " PRED GDAXI W1 NUEVA -> " + nuevaPrediccion);
		}catch (Exception e) {
