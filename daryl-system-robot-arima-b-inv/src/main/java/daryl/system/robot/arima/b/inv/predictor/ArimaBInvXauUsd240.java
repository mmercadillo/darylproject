...
import daryl.system.robot.arima.b.inv.predictor.config.ConfiguracionArimaXauUsd240;
import daryl.system.robot.arima.b.inv.repository.IHistXauUsdRepository;
import lombok.ToString;

@Component(value = "arimaBInvXauusd240")
@ToString
public class ArimaBInvXauUsd240  extends ArimaPredictor{
	...
	//private final String robot = "ARIMA_I_B_XAUUSD_240";
	...
	public void calculate(Robot bot) {
		...
		//logger.info("Nueva predicción para el XAUUSD H4 : {} a las: {}" , prediccion, config.getActualDateFormattedInString());
