...
import daryl.system.robot.arima.b.inv.predictor.config.ConfiguracionArimaAudCad240;
import daryl.system.robot.arima.b.inv.repository.IHistAudCadRepository;
import lombok.ToString;

@Component(value = "arimaBInvAudcad240")
@ToString
public class ArimaBInvAudcad240  extends ArimaPredictor{
