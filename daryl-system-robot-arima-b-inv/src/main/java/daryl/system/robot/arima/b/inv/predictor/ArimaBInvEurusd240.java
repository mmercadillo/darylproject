...
import daryl.system.robot.arima.b.inv.predictor.config.ConfiguracionArimaEurUsd240;
import daryl.system.robot.arima.b.inv.repository.IHistEurUsdRepository;
import lombok.ToString;

@Component(value = "arimaBInvEurusd240")
@ToString
public class ArimaBInvEurusd240  extends ArimaPredictor{
	
	@Autowired(required = true)
	ConfiguracionArimaEurUsd240 configuracion;
	@Autowired
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//logger.info("Nueva predicción para el EURUSD H4 : {} a las: {}" , prediccion, config.getActualDateFormattedInString());
