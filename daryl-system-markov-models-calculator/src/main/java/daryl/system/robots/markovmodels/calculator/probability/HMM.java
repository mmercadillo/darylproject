...
public class HMM{
	...
	private static final String FROM1 = "20120102";
	private static final String TO1 = "20140519";
    private static final String FROM2 = "20140518";
    private static final String TO2 = "20150122";
    private static final String FROM3 = "20150121";
    private static final String TO3 = "20160214";
    private static final String FROM4 = "20160212";
    private static final String TO4 ="20170724";
    ...
    String predictionDate = "20161122";
    String yesterdayDate = "20161121";
    String likelihoodDate = "20170421";
    ...
    private Hmm<?> initializeHmm(){
        ...
        OpdfMultiGaussianMixture opdf1 = createOpdfMultiGaussianMixture(0, 1, D, M, null);
        OpdfMultiGaussianMixture opdf2 = createOpdfMultiGaussianMixture(0, 1, D, M, null);
        OpdfMultiGaussianMixture opdf3 = createOpdfMultiGaussianMixture(0, 1, D, M, null);
        OpdfMultiGaussianMixture opdf4 = createOpdfMultiGaussianMixture(0, 1, D, M, null);
    ...
    private OpdfMultiGaussianMixture createOpdfMultiGaussianMixture(double mean, double covariance,int dim, int mixtures, double[] mixtureProps)
    {
            return new OpdfMultiGaussianMixture(createMultiGaussianMixtureDistribution(mean, covariance,dim, mixtures, mixtureProps));
    }
    ...
    private  List<Sensex> getData(String from ,String to) throws FileNotFoundException, IOException, ParseException{
    	...
    	boolean valid = false;
        BufferedReader bufferedReader = new BufferedReader(new FileReader("F:\\DarylWorkspace\\Historicos\\h\\XAUUSD_1440.csv"));
