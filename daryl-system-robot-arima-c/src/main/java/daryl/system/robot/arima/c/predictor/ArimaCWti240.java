...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaWti240;
...
@Component(value = "arimaCWti240")
@ToString
public class ArimaCWti240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_C_WTI_240";
