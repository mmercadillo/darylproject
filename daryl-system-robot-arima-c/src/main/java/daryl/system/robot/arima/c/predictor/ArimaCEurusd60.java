...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaEurUsd60;
...
@Component(value = "arimaCEurusd60")
@ToString
public class ArimaCEurusd60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_C_EURUSD_60";
