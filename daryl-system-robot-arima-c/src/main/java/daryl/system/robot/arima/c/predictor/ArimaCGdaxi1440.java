...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaGdaxi1440;
...
@Component(value = "arimaCGdaxi1440")
@ToString
public class ArimaCGdaxi1440  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_C_GDAXI_1440";	
