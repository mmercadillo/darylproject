...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaGdaxi;
...
@Component(value = "arimaCGdaxi60")
@ToString
public class ArimaCGdaxi60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_C_GDAXI_60";
