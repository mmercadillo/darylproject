...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaGdaxi10080;
import daryl.system.robot.arima.c.repository.IArimaConfigRepository;
import daryl.system.robot.arima.c.repository.IHistGdaxiRepository;
import lombok.ToString;

@Component(value = "arimaCGdaxi10080")
@ToString
public class ArimaCGdaxi10080  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_C_GDAXI_10080";
