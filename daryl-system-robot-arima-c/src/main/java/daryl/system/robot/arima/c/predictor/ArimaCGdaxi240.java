...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaGdaxi240;
...
@Component(value = "arimaCGdaxi240")
@ToString
public class ArimaCGdaxi240  extends ArimaPredictor{
