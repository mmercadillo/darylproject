...
import daryl.system.robot.arima.c.predictor.config.ConfiguracionArimaXauUsd240;
...
@Component(value = "arimaCXauusd240")
@ToString
public class ArimaCXauUsd240  extends ArimaPredictor{
