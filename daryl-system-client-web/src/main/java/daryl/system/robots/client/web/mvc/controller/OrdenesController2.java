...
public class OrdenesController2 {
    ...
    public List<OrdenDto> ordenesEmTf1440(@PathVariable String cta) {
		...
		List<ResumenRobot> top5EspMat = resumenService.findResumenRobotsByRobotContainingIgnoreCaseOrderByEspmatDesc("1440",5);
		List<String> robots = new ArrayList<String>();
		//Recuperamos la orden por robot
		if(top5EspMat != null) {
			for (ResumenRobot resumen : top5EspMat) {
    ...
    public List<OrdenDto> ordenesEmTf10080(@PathVariable String cta) {
		...
		List<ResumenRobot> top5EspMat = resumenService.findResumenRobotsByRobotContainingIgnoreCaseOrderByEspmatDesc("10080",5);
		List<String> robots = new ArrayList<String>();
		//Recuperamos la orden por robot
		if(top5EspMat != null) {
			for (ResumenRobot resumen : top5EspMat) {
    ...
    public List<OrdenDto> ordenesTotalTf1440(@PathVariable String cta) {
		...
		List<ResumenRobot> top5EspMat = resumenService.findResumenRobotsByRobotContainingIgnoreCaseOrderByTotalDesc("1440",5);
		List<String> robots = new ArrayList<String>();
		//Recuperamos la orden por robot
		if(top5EspMat != null) {
			for (ResumenRobot resumen : top5EspMat) {
