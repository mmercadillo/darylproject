...
public class TopRobotsTotalByTimeframeController {
    ...
    public List<ResumenRobotDto> top5Total60() {
		...
		List<ResumenRobot> top5EspMat = resumenRobotService.findResumenRobotsByRobotContainingIgnoreCaseAndNumOperacionesGreaterThanEqualOrderByTotalDesc("60", 50L, 5);
    ...
    public List<ResumenRobotDto> top5Total240() {
		...
		//Card con el top5 en esperanza matemática con tf 60
		List<ResumenRobot> top5EspMat = resumenRobotService.findResumenRobotsByRobotContainingIgnoreCaseAndNumOperacionesGreaterThanEqualOrderByTotalDesc("240", 25L, 5);
		List<ResumenRobotDto> resumenes = new ArrayList<ResumenRobotDto>();
		for (ResumenRobot resumen : top5EspMat) {
			if(resumen != null) resumenes.add(ResumenRobotDto.getDto(resumen));
		}
    ...
    public List<ResumenRobotDto> top5Total1440() {
		...
		//Card con el top5 en esperanza matemática con tf 60
		List<ResumenRobot> top5EspMat = resumenRobotService.findResumenRobotsByRobotContainingIgnoreCaseAndNumOperacionesGreaterThanEqualOrderByTotalDesc("1440", 10L, 5);
		List<ResumenRobotDto> resumenes = new ArrayList<ResumenRobotDto>();
		for (ResumenRobot resumen : top5EspMat) {
			if(resumen != null) resumenes.add(ResumenRobotDto.getDto(resumen));
		}
    ...
    public List<ResumenRobotDto> top5Total10080() {
		...
		//Card con el top5 en esperanza matemática con tf 60
		List<ResumenRobot> top5EspMat = resumenRobotService.findResumenRobotsByRobotContainingIgnoreCaseAndNumOperacionesGreaterThanEqualOrderByTotalDesc("10080", 4L, 5);
		List<ResumenRobotDto> resumenes = new ArrayList<ResumenRobotDto>();
		for (ResumenRobot resumen : top5EspMat) {
			if(resumen != null) resumenes.add(ResumenRobotDto.getDto(resumen));
		}
