package daryl.system.robot.arima.b3.predictor.base;
...
import daryl.system.robot.arima.b3.repository.IHistoricoRepository;
import daryl.system.robot.arima.b3.repository.IOrdenRepository;
import daryl.system.robot.arima.b3.repository.IPrediccionRepository;

public abstract class ArimaB3Predictor {
	...
	protected Double calcularPrediccion(Robot bot) {
		...
		try {
			...
			List<Historico> historico = historicoRepository.findAllByTimeframeAndActivoOrderByFechaHoraDesc(bot.getTimeframe(), bot.getActivo(), PageRequest.of(0,  pagina + 1));
	...
	private final Orden calcularOperacion(Robot robot, Double prediccion, Boolean inv) {
		...
		String estrategia = "ARIMA_B_" + robot.getActivo() + "_1440";
