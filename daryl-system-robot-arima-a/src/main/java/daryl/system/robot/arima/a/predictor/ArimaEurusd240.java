...
import daryl.system.robot.arima.a.predictor.config.ConfiguracionArimaEurUsd240;
import daryl.system.robot.arima.a.repository.IHistEurUsdRepository;
import lombok.ToString;

@Component(value = "arimaEurusd240")
@ToString
public class ArimaEurusd240  extends ArimaPredictor{
	...
	private static final String robot = "ARIMA_EURUSD_240";
