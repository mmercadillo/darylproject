...
import daryl.system.robot.arima.a.predictor.config.ConfiguracionArimaNdx10080;
import daryl.system.robot.arima.a.repository.IHistNdxRepository;
import lombok.ToString;

@Component(value = "arimaNdx10080")
@ToString
public class ArimaNdx10080  extends ArimaPredictor{
	...
	private static final String robot = "ARIMA_NDX_10080";
	...
	public void calculate(Activo activo, String estrategia) {
		...
		//ArimaNdxW1Controller.orden = orden.getTipoOrden();
