...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaAudCad60;
...
@Component(value = "arimaDAudcad60")
@ToString
public class ArimaDAudcad60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_D_AUDCAD_60";
