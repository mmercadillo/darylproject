package daryl.system.robot.arima.d;
...
public class DarylSystemRobotArimaDApplication {
	...
	public static void main(String[] args) {
        ...
        SpringApplicationBuilder builder = new SpringApplicationBuilder(DarylSystemRobotArimaDApplication.class);
