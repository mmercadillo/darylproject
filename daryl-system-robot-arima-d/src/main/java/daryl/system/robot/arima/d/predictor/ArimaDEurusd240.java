...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaEurUsd240;
...
@Component(value = "arimaDEurusd240")
@ToString
public class ArimaDEurusd240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_D_EURUSD_240";
