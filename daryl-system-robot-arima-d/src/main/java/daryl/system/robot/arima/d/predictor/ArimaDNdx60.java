...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaNdx60;
...
@Component(value = "arimaDNdx60")
@ToString
public class ArimaDNdx60  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_D_NDX_60";
