...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaGdaxi240;
...
@Component(value = "arimaDGdaxi240")
@ToString
public class ArimaDGdaxi240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_D_GDAXI_240";
