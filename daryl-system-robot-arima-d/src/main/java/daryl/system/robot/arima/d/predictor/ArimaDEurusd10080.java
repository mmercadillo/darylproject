...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaEurUsd10080;
import daryl.system.robot.arima.d.repository.IArimaConfigRepository;
import daryl.system.robot.arima.d.repository.IHistEurUsdRepository;
import lombok.ToString;

@Component(value = "arimaDEurusd10080")
@ToString
public class ArimaDEurusd10080  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_D_EURUSD_10080";
