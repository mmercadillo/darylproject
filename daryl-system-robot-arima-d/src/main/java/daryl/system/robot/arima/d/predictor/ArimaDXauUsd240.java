...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaXauUsd240;
...
@Component(value = "arimaDXauusd240")
@ToString
public class ArimaDXauUsd240  extends ArimaPredictor{
	...
	private final String robot= "ARIMA_D_XAUUSD_240";
