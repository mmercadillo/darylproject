...
import daryl.system.robot.arima.d.predictor.config.ConfiguracionArimaNdx240;
...
@Component(value = "arimaDNdx240")
@ToString
public class ArimaDNdx240  extends ArimaPredictor{
	...
	//private final String robot= "ARIMA_D_NDX_240";
